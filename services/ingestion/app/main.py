...
def _save_file_and_db(doc_id: str, filename: str, file_path: str, upload_dir: str, file_obj) -> None:
...
async def ingest_document(background_tasks: BackgroundTasks, file: UploadFile = File(...)):
    ...
    await asyncio.to_thread(_save_file_and_db, doc_id, file.filename, file_path, UPLOAD_DIR, file.file)
